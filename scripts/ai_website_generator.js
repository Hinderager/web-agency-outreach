...
Generate a complete, production-ready website that would impress potential customers and drive conversions.`;
  ...
  async generateWebsiteWithTemplate(leadData, analysisResults) {
    try {
      ...
      let websiteHTML = template
        ...
        .replace(/\{\{primaryColor\}\}/g, analysisResults.primaryColor || '#0ea5e9')
        .replace(/\{\{secondaryColor\}\}/g, analysisResults.secondaryColor || '#111827')
  ...
  addIndustrySpecificContent(html, industry, leadData) {
    const industryContent = {
      ...
      'plumbing': {
        headline: `Expert Plumbing Services in ${leadData.city}`,
...
<body>
    ...
    <section class="about">
        <div class="container">
            ...
            <p>We are committed to providing exceptional {{industry}} services to the {{city}} community. With years of experience and a dedication to quality, we ensure every project meets the highest standards.</p>
